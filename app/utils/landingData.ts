export const landingData = {
  ...
  lunar: {
    labels: {
      ...
      nextFull: 'NEXT_FULL',
      nextNew: 'NEXT_NEW',
      activeLink: 'OBSERVER::ACTIVE_LINK',
      velocity: 'ORBITAL // VELOCITY',
      raDec: 'COORDINATES // RA_DEC',
      events: 'ORBITAL // EVENTS',
      coords: 'LOC_SYSLOG::COORDS',
      altitude: 'ALTITUDE',
      azimuth: 'AZIMUTH',
      age: 'Age',
      illum: 'Illum',
      ...
      sigDelay: 'SIG_DELAY',
      subLuna: 'SUB_LUNA',
      rAscension: 'R_ASCENSION',
      declination: 'DECLINATION',
      zodiacSign: 'ZODIAC_SIGN',
      constellation: 'CONSTELLATION',
      nextPerigee: 'NEXT_PERIGEE',
      nextApogee: 'NEXT_APOGEE',
      gravity: 'GRAVITY',
      escapeV: 'ESCAPE_V',
      rise: 'Rise',
      set: 'Set',
      latitude: 'LATITUDE',
      longitude: 'LONGITUDE',
      orbitalSync: 'simulation::orbital_sync',
      orbitalPath: 'ORBITAL PATH — SUNCALC LIVE',
      currentDist: 'CURRENT_DIST',
      approachingPerigee: 'APPROACHING PERIGEE',
      recedingApogee: 'RECEDING → APOGEE',
      lunarObs: 'LUNAR_OBS',
      ticker: 'GEOGRAPHIC_PARALLAX_SYNC // SUNCALC_FEED // SOUTHERN_HEMISPHERE_CALIBRATED',
      shCalibration: 'SH_CALIBRATION',
      signalLoss: 'SIGNAL_LOSS // IP_DEFAULT',
