...
<template>
  <div class="absolute inset-0 pointer-events-none overflow-hidden broken-terminal-jitter">
      ...
      <div class="space-y-6">
        ...
        >
          ...
          <div class="w-24 sm:w-48 h-1 bg-white/5 relative overflow-hidden flex items-center">
            ...
            <div class="absolute right-0 top-0 text-[7px] font-mono text-hud-accent/30 uppercase mr-[-24px]">
              {{ row.unit }}
            </div>
          </div>
        </div>
    ...
    <!-- 5. HUD CALIBRATION RING (Centre-Oriented around Moon) -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.2] pointer-events-none scale-150 bento-flicker">
      ...
      >
        ...
        />
        <path
          d="M 120 10 L 120 20 M 120 220 L 120 230 M 10 120 L 20 120 M 220 120 L 230 120"
          stroke="currentColor"
          stroke-width="1"
        />
        <rect
